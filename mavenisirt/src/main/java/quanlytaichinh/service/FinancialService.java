...
public interface FinancialService {
    double GetTotalInCome(int id,int month);
    double GetTotalSpend(int id, int month);
    double GetTotalSaving(int id, int month);
    double GetTotalInvest_Property(int id, int month);
    double GetTotalLoanRemain(int id, int month);
    double GetTotalInvest(int id, int month);
    double NetAsset(int id, int month);
